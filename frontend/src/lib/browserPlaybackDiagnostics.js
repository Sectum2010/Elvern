...
export function buildBrowserPlaybackDiagnosticPayload({
  ...
  return {
    ...
    lite_threshold_decider_state: pickString(session, ["lite_threshold_decider_state"]),
    lite_threshold_previous_tier: pickString(session, ["lite_threshold_previous_tier"]),
    lite_threshold_candidate_tier: pickString(session, ["lite_threshold_candidate_tier"]),
    lite_threshold_confirmed_tier: pickString(session, ["lite_threshold_confirmed_tier"]),
    lite_threshold_decider_reason: pickString(session, ["lite_threshold_decider_reason"]),
    lite_positive_evidence_seconds: pickNumber(session, ["lite_positive_evidence_seconds"]),
    lite_negative_evidence_seconds: pickNumber(session, ["lite_negative_evidence_seconds"]),
    lite_frontier_sample_count: pickNumber(session, ["lite_frontier_sample_count"]),
    lite_frontier_growth_rate_x: pickNumber(session, ["lite_frontier_growth_rate_x"]),
    lite_effective_supply_rate_x: pickNumber(session, ["lite_effective_supply_rate_x"]),
    lite_supply_fast_ema_rate_x: pickNumber(session, ["lite_supply_fast_ema_rate_x"]),
    lite_supply_slow_ema_rate_x: pickNumber(session, ["lite_supply_slow_ema_rate_x"]),
    lite_supply_median_rate_x: pickNumber(session, ["lite_supply_median_rate_x"]),
    lite_hysteresis_hold_reason: pickString(session, ["lite_hysteresis_hold_reason"]),
    lite_cold_start_hold: pickBoolean(session, ["lite_cold_start_hold"]),
    lite_post_recovery_hold: pickBoolean(session, ["lite_post_recovery_hold"]),
    lite_post_seek_hold: pickBoolean(session, ["lite_post_seek_hold"]),
