...
describe("browser playback diagnostics", () => {
  test("builds a safe snapshot with backend and client gate fields", () => {
    const session = {
      ...
      lite_threshold_candidate_tier: "lite_undersupply",
      lite_threshold_confirmed_tier: "lite_undersupply",
      lite_threshold_decider_reason: "lite_undersupply_confirmed",
      lite_threshold_decider_state: "undersupply_confirmed_180",
      lite_threshold_previous_tier: "lite_uncertain",
      lite_positive_evidence_seconds: 0,
      lite_negative_evidence_seconds: 28,
      lite_frontier_sample_count: 7,
      lite_frontier_growth_rate_x: 0.72,
      lite_effective_supply_rate_x: 0.72,
      lite_supply_fast_ema_rate_x: 0.74,
      lite_supply_slow_ema_rate_x: 0.76,
      lite_supply_median_rate_x: 0.72,
      lite_hysteresis_hold_reason: "sustained_bad_evidence",
    ...
    const payload = buildBrowserPlaybackDiagnosticPayload({
      ...
      releaseGate: {
        ...
        clientReady: false,
        configuredClientCacheSeconds: 15,
        configuredServerPrepareSeconds: 180,
        ready: false,
        requiredClientCacheSeconds: 15,
        requiredServerPrepareSeconds: 180,
        serverReady: false,
      },
      livenessSample: {
    ...
    expect(payload).toMatchObject({
      ...
      configured_client_cache_seconds: 15,
      configured_server_prepare_seconds: 180,
      duration_seconds: 7877,
      engine_mode: "route2",
      ...
      required_client_buffer_seconds: 15,
      required_client_cache_seconds: 15,
      required_server_prepare_seconds: 180,
      required_startup_runway_seconds: 180,
      session_id: "session-1",
      supply_rate_x: 0.72,
  ...
  test("captures recovery decision fields without exposing transport or path details", () => {
    const payload = buildBrowserPlaybackDiagnosticPayload({
      ...
      recoveryTarget: {
        recoveryReason: "native_hls_playlist_stale",
        backrollSeconds: 2.5,
        authorityPositionSeconds: 160,
        targetBeforeBackrollSeconds: 160,
        targetAfterBackrollSeconds: 157.5,
    ...
    expect(payload).toMatchObject({
      ...
      recovery_authority_position_seconds: 160,
      recovery_backroll_seconds: 2.5,
      recovery_committed_playhead_seconds: 160,
      recovery_current_absolute_position_seconds: 163,
      recovery_decision_reason: "native_hls_playlist_starved",
      recovery_decision_start: true,
      recovery_actual_media_element_time_seconds: 160,
      recovery_avoided_forward_skip: true,
      recovery_last_stable_position_seconds: 160,
      recovery_reason: "native_hls_playlist_stale",
      recovery_target_after_backroll_seconds: 157.5,
      recovery_target_before_backroll_seconds: 160,
