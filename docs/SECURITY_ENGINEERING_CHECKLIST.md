...
- For private/public exposure planning, see `docs/EXPOSURE_MODE_PLANNER.md`; Phase 1 drafts must stay non-activating and must not perform backend requests to candidate origins.
