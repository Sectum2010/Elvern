...
def _to_user_settings_response(payload: dict[str, object], *, user_role: str) -> UserSettingsResponse:
    ...
    return UserSettingsResponse(
        ...
        desktop_floating_island_position=str(payload["desktop_floating_island_position"]),
...
def patch_user_settings(
    ...
    try:
        updated = update_user_settings(
            ...
            desktop_floating_island_position=payload.desktop_floating_island_position,
