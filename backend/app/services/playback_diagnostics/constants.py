...
SCHEMA_VERSION = "playback-diagnostics-event-v1"
JOURNAL_SCHEMA_VERSION = "elvern-diagnostics-journal-v1"
CATALOG_SCHEMA_VERSION = "playback-diagnostics-catalog-v1"
