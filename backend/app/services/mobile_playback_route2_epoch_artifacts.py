    ...
    *,
    ...
    write_json_atomic(
        epoch.metadata_path,
        {
            ...
            "adaptive_downshift_switched_at": epoch.adaptive_downshift_switched_at,
            "adaptive_downshift_aborted_reason": epoch.adaptive_downshift_aborted_reason,
            "adaptive_reclaim_request_id": epoch.adaptive_reclaim_request_id,
            "adaptive_reclaim_consumer_session_id": epoch.adaptive_reclaim_consumer_session_id,
            "adaptive_reclaim_consumer_user_id": epoch.adaptive_reclaim_consumer_user_id,
            "adaptive_reclaim_consumer_media_item_id": epoch.adaptive_reclaim_consumer_media_item_id,
            "adaptive_reclaim_consumer_reason": epoch.adaptive_reclaim_consumer_reason,
