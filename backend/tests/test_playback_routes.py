                ...
                "items": [
                    {
                        ...
                        "reserve_target_ready_end_seconds": 1737.01,
                        "reserve_actual_ready_end_seconds": 957.01,
                        "reserve_required_seconds": 900.0,
                        "reserve_remaining_seconds": 780.0,
                        "reserve_satisfied": False,
                        "reserve_blocks_admission": True,
                        "reserve_eta_seconds": 750.0,
...
def test_admin_playback_workers_route_returns_route2_worker_registry(
    ...
    assert first_item["reserve_target_ready_end_seconds"] == 1737.01
    assert first_item["reserve_actual_ready_end_seconds"] == 957.01
    assert first_item["reserve_remaining_seconds"] == 780.0
